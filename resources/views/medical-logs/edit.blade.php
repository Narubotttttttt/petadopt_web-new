    ...
    <div class="max-w-3xl mx-auto py-10 px-4">
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="flex items-center gap-3 mb-8 border-b-2 border-[#199CA4] pb-4">
                ...
                <h1 class="text-xl font-bold text-gray-900">Edit Medical Log</h1>
            </div>
            ...
            <form action="{{ route('medical-logs.update', $medicalLog) }}" method="POST" class="space-y-6">
                ...
                <div x-data="{
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="category" x-model="category" @change="nextDueDate = ''" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white focus:border-[#199CA4] focus:ring-4 focus:ring-[#199CA4]/10 transition outline-none shadow-sm text-gray-800" required>
                    ...
                    <div class="mt-6">
                        ...
                        <template x-if="category !== 'vaccination' && category !== ''">
                            <div>
                                ...
                                <input type="date" name="next_due_date" x-model="nextDueDate" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-[#199CA4] focus:ring-4 focus:ring-[#199CA4]/10 transition outline-none shadow-sm text-gray-800">
                            </div>
                        </template>
                    </div>
                </div>
                ...
                <div>
                    <label class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Administered By</label>
                    <input type="text" name="administered_by" value="{{ old('administered_by', $medicalLog->administered_by) }}" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-[#199CA4] focus:ring-4 focus:ring-[#199CA4]/10 transition outline-none shadow-sm text-gray-800">
                </div>
                ...
                <div class="flex items-center gap-3 justify-end border-t border-gray-100 pt-6">
                    ...
                    <button type="submit" class="px-6 py-2.5 bg-[#199CA4] text-white text-sm font-semibold rounded-xl hover:bg-[#13787F] shadow-md shadow-[#199CA4]/10 transition">Update Entry</button>
                </div>
            </form>
        </div>
    </div>
