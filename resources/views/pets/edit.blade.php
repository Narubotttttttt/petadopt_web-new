        ...
        <div class="bg-white dark:bg-[#12141C] p-8 rounded-2xl shadow-sm dark:shadow-xl dark:shadow-black/40 border border-gray-100 dark:border-white/[0.07]">
            ...
            <form action="{{ route('pets.update', $pet) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex items-center gap-3 justify-end border-t border-gray-100 dark:border-white/[0.06] pt-6">
                    ...
                    <button type="submit"
                        class="px-6 py-2.5 bg-[#199CA4] text-white text-sm font-semibold rounded-xl hover:bg-[#13787F] shadow-md shadow-[#199CA4]/10 transition cursor-pointer">Update Pet Profile</button>
                </div>
            </form>
        </div>
    </div>
