    ...
    <div class="max-w-4xl mx-auto py-10 px-4 animate-fade-in">
        <div class="bg-white dark:bg-[#0e1d20] p-8 sm:p-10 rounded-3xl shadow-card border border-slate-200/80 dark:border-slate-800 relative overflow-hidden">
            ...
            <div class="flex items-center gap-3.5 mb-8 border-b border-slate-100 dark:border-slate-800 pb-6">
                ...
                <div>
                    <h1 class="text-xl sm:text-2xl font-extrabold text-slate-800 dark:text-white tracking-tight">Register New Pet</h1>
                    <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">Add a rescued dog or cat into the CAWS adoption directory.</p>
                </div>
            </div>
            ...
            <form action="{{ route('pets.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex items-center gap-3 justify-end border-t border-slate-100 dark:border-slate-800 pt-6 mt-8">
                    ...
                    <button type="submit"
                        class="px-6 py-2.5 bg-gradient-to-r from-[#199CA4] to-[#14838B] hover:from-[#146970] hover:to-[#12585e] text-white text-xs sm:text-sm font-extrabold rounded-xl shadow-md shadow-[#199CA4]/25 hover:shadow-lg hover:shadow-[#199CA4]/30 transition-all cursor-pointer">Save Pet Profile</button>
                </div>
            </form>
        </div>
    </div>
