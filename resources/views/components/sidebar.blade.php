<div class="hidden lg:block fixed inset-y-0 left-0 z-40">
	<aside class="w-64 h-full overflow-y-auto border-r border-[#199CA4]/15 bg-gradient-to-b from-[#081b20] via-[#0b242a] to-[#061519] text-slate-300 shadow-2xl flex flex-col justify-between select-none">
		<div class="px-4 py-6">
			{{-- Brand Header --}}
			<div class="flex items-center gap-3.5 mb-8 h-12 px-2.5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md shadow-inner">
				<div class="relative shrink-0">
					<img src="{{ asset('images/caws-logo.jpg') }}" alt="CAWS Logo" class="w-9 h-9 rounded-xl object-cover ring-2 ring-[#199CA4] shadow-md shadow-[#199CA4]/30">
					<span class="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-emerald-400 rounded-full border-2 border-[#081b20] animate-pulse"></span>
				</div>
				<div class="whitespace-nowrap min-w-0">
					<h2 class="text-xs font-extrabold text-white leading-tight tracking-tight truncate uppercase">CDO Animal Welfare</h2>
					<p class="text-[10px] text-[#41C1CB] font-bold tracking-widest uppercase">Society Inc.</p>
				</div>
			</div>
