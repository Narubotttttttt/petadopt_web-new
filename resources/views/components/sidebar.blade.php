<div class="hidden lg:block fixed inset-y-0 left-0 z-40">
	<aside class="w-64 h-full overflow-y-auto border-r border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#0B0F19] text-slate-700 dark:text-slate-300 shadow-sm flex flex-col justify-between select-none transition-colors duration-150">
		<div class="px-4 py-6">
			{{-- Brand Header (Clean unboxed style) --}}
			<div class="flex items-center gap-3 mb-8 h-10 px-1">
				<img src="{{ asset('images/caws-logo.jpg') }}" alt="CAWS Logo" class="w-10 h-10 shrink-0 rounded-xl object-cover border border-slate-200 dark:border-slate-700 shadow-xs">
				<div class="whitespace-nowrap min-w-0">
					...
					<p class="text-xs text-slate-500 dark:text-slate-400 font-medium truncate">Society Inc.</p>
				</div>
			</div>
			...
			<nav class="space-y-1" aria-label="Main navigation">
				...
				<p class="text-[10px] font-extrabold uppercase tracking-widest text-slate-400 dark:text-slate-500 px-3 pt-2 pb-1 flex items-center gap-1.5">
				...
				<p class="text-[10px] font-extrabold uppercase tracking-widest text-slate-400 dark:text-slate-500 px-3 pt-4 pb-1 flex items-center gap-1.5">
					<span class="w-1.5 h-1.5 rounded-full bg-[#199CA4]"></span>
					Management
				</p>
				...
				<a href="{{ route('pets.index') }}" title="Pets"
					class="group relative flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all duration-150 {{ request()->routeIs('pets.*') ? 'bg-[#199CA4]/10 dark:bg-[#199CA4]/15 text-[#199CA4] dark:text-[#41C1CB]' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800/60' }}">
					@if(request()->routeIs('pets.*'))
						<span class="absolute left-0 top-2 bottom-2 w-1 rounded-r-full bg-[#199CA4]"></span>
					@endif
					<span class="inline-flex items-center justify-center w-8 h-8 shrink-0 rounded-xl transition-all duration-150 {{ request()->routeIs('pets.*') ? 'bg-[#199CA4]/20 text-[#199CA4] dark:text-[#41C1CB]' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 group-hover:bg-[#199CA4]/10 group-hover:text-[#199CA4] dark:group-hover:text-[#41C1CB]' }}">
				...
				@if(Auth::user()->role === 'admin')
					<a href="{{ route('users.index') }}" title="User Management"
						class="group relative flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all duration-150 {{ request()->routeIs('users.*') ? 'bg-[#199CA4]/10 dark:bg-[#199CA4]/15 text-[#199CA4] dark:text-[#41C1CB]' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800/60' }}">
						@if(request()->routeIs('users.*'))
							<span class="absolute left-0 top-2 bottom-2 w-1 rounded-r-full bg-[#199CA4]"></span>
						@endif
						<span class="inline-flex items-center justify-center w-8 h-8 shrink-0 rounded-xl transition-all duration-150 {{ request()->routeIs('users.*') ? 'bg-[#199CA4]/20 text-[#199CA4] dark:text-[#41C1CB]' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 group-hover:bg-[#199CA4]/10 group-hover:text-[#199CA4] dark:group-hover:text-[#41C1CB]' }}">
				...
				<a href="{{ route('adoption-applications.index') }}" title="Adoption Requests"
					class="group relative flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all duration-150 {{ request()->routeIs('adoption-applications.*') ? 'bg-[#199CA4]/10 dark:bg-[#199CA4]/15 text-[#199CA4] dark:text-[#41C1CB]' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800/60' }}">
					@if(request()->routeIs('adoption-applications.*'))
						<span class="absolute left-0 top-2 bottom-2 w-1 rounded-r-full bg-[#199CA4]"></span>
					@endif
					<span class="inline-flex items-center justify-center w-8 h-8 shrink-0 rounded-xl transition-all duration-150 {{ request()->routeIs('adoption-applications.*') ? 'bg-[#199CA4]/20 text-[#199CA4] dark:text-[#41C1CB]' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 group-hover:bg-[#199CA4]/10 group-hover:text-[#199CA4] dark:group-hover:text-[#41C1CB]' }}">
				...
				<a href="{{ route('adopters.index') }}" title="Adopters"
					class="group relative flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all duration-150 {{ request()->routeIs('adopters.*') ? 'bg-[#199CA4]/10 dark:bg-[#199CA4]/15 text-[#199CA4] dark:text-[#41C1CB]' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800/60' }}">
					@if(request()->routeIs('adopters.*'))
						<span class="absolute left-0 top-2 bottom-2 w-1 rounded-r-full bg-[#199CA4]"></span>
					@endif
					<span class="inline-flex items-center justify-center w-8 h-8 shrink-0 rounded-xl transition-all duration-150 {{ request()->routeIs('adopters.*') ? 'bg-[#199CA4]/20 text-[#199CA4] dark:text-[#41C1CB]' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 group-hover:bg-[#199CA4]/10 group-hover:text-[#199CA4] dark:group-hover:text-[#41C1CB]' }}">
				...
				<a href="{{ route('medical-logs.index') }}" title="Medical Logs"
					class="group relative flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all duration-150 {{ request()->routeIs('medical-logs.*') ? 'bg-[#199CA4]/10 dark:bg-[#199CA4]/15 text-[#199CA4] dark:text-[#41C1CB]' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800/60' }}">
					@if(request()->routeIs('medical-logs.*'))
						<span class="absolute left-0 top-2 bottom-2 w-1 rounded-r-full bg-[#199CA4]"></span>
					@endif
					<span class="inline-flex items-center justify-center w-8 h-8 shrink-0 rounded-xl transition-all duration-150 {{ request()->routeIs('medical-logs.*') ? 'bg-[#199CA4]/20 text-[#199CA4] dark:text-[#41C1CB]' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 group-hover:bg-[#199CA4]/10 group-hover:text-[#199CA4] dark:group-hover:text-[#41C1CB]' }}">
		...
		<div class="p-4 border-t border-slate-200/80 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30">
			<div class="p-3 bg-slate-100/80 dark:bg-slate-800/50 rounded-2xl border border-slate-200/80 dark:border-slate-700/60 flex items-center gap-3">
				...
				<div class="min-w-0 flex-1">
					...
					<p class="text-[10px] text-[#199CA4] dark:text-[#41C1CB] font-medium tracking-wide">CAWS Cloud v2.0</p>
				</div>
			</div>
		</div>
	</aside>
