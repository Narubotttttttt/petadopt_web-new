<nav x-data="{ mobileNavOpen: false }" class="bg-white/90 dark:bg-[#090A0F]/90 backdrop-blur-xl border-b border-gray-200/80 dark:border-white/[0.06] sticky top-0 z-30 shadow-xs transition-colors duration-150">
